                  ...
                  <tbody>
                    ...
                    <tr>
                      <td colspan="5" class="text-center">
                        <h6 class="text-muted">Telah ada {{$jumlah_warisan_budaya}} Pencatatan Warisan Budaya, belum ada Pengusulan Baru</h6>
                        <a class="btn bg-gradient-light btn-md mt-4 mb-4" href="{{ url("/admin/wbtb") }}"> Cek Warisan Budaya yg telah diverifikasi</a>
                      </td>
                    </tr>
                    @endforelse
                  </tbody>
