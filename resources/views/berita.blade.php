      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-7 text-center mx-auto">
            <h1 class="text-white pt-3 mt-n5">Berita</h1>
            <p class="lead text-white mt-3">Kabar terbaru dan berita terkait Warisan Budaya Tak Benda DIY.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-12">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-6 justify-content-center d-flex flex-column pl-lg-5 pt-lg-0 pt-3">
            <h3 class="card-title">
              <a href="{{ url('berita/'.$berita->id) }}" class="text-dark">{{$berita->judul}}</a>
            </h3>
            <p class="card-description">
              
              {!!substr(strip_tags($berita->konten, '<p>'),0,270)!!}... <br/>
              <a href="{{ url('berita/'.$berita->id) }}" class="text-darker icon-move-right text-sm">Read More
