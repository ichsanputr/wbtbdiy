<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('index') }}">
            <img src="{{ asset('assets/img/logo.png') }}" class="navbar-brand-img h-100" alt="..."  width="54" height="44">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user.pengusulan' ? 'active' : '' }}"
                    href="{{ route('user.pengusulan') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Form Pengusulan</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user.tables' ? 'active' : '' }}"
                    href="{{ route('user.tables') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user.billing' ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user.rtl' ? 'active' : '' }}"
                    href="{{ route('rtl') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
