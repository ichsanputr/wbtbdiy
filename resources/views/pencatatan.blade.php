      ...
      <div class="col-lg-12">
        <div class="row">
          ...
          <div class="col-lg-6 justify-content-center d-flex flex-column pl-lg-5 pt-lg-0 pt-3">
            ...
            <p class="author">
              oleh <a href="javascript:;" class="ms-1"><span class="font-weight-bold text-primary"> Sarah Aulina</span></a>, 2 hari yang lalu
            </p>
          </div>
        </div>
        <div class="row mt-5">
          ...
          <div class="col-lg-6 justify-content-center d-flex flex-column pl-lg-5 pt-lg-0 pt-3">
            ...
            <h3 class="card-title">
              <a href="javascript:;" class="text-dark">Sayur Lodeh</a>
            </h3>
            <p class="card-description">
              Warner Music Group announced today it’s acquiring the selected assets of the music platform Songkick, including its app for finding concerts and the company’s trademark. Songkick has been involved in a lawsuit against the major… <a href="javascript:;" class="text-darker icon-move-right text-sm">Read More
                <i class="fas fa-arrow-right text-xs ms-1" aria-hidden="true"></i>
            ...
            <p class="author">
              oleh <a href="javascript:;" class="ms-1"><span class="font-weight-bold text-warning"> Sarah Aulina</span></a>, 2 hari yang lalu
            </p>
          </div>
        </div>
        <div class="row mt-5">
          ...
          <div class="col-lg-6 justify-content-center d-flex flex-column pl-lg-5 pt-lg-0 pt-3">
            <h6 class="category text-primary mt-3">Seni Pertunjukan</h6>
            <h3 class="card-title">
              <a href="javascript:;" class="text-dark">Tarian Srimpi Muncar</a>
            </h3>
            <p class="card-description">
              Warner Music Group announced today it’s acquiring the selected assets of the music platform Songkick, including its app for finding concerts and the company’s trademark. Songkick has been involved in a lawsuit against the major… <a href="javascript:;" class="text-darker icon-move-right text-sm">Read More
                <i class="fas fa-arrow-right text-xs ms-1" aria-hidden="true"></i>
