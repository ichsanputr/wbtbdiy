...
<header>
    <div class="page-header min-vh-85" style="background-position-y: 50%;">
      <div class="position-absolute border-radius-lg border-top-start-radius-0 border-top-end-radius-0 border-bottom-end-radius-0 fixed-top ms-auto w-75 h-100 z-index-0 d-none d-sm-none d-md-block" style="background-image: url('{{asset('upload/'.$pencatatan->foto)}}'); background-size:cover;">
      </div>
      <div class="container">
        <div class="row">
          <div class="col-lg-7 d-flex justify-content-center flex-column">
            <div class="card card-body blur d-flex justify-content-center px-5 shadow-lg mt-lg-5 mt-3 py-5">
              <strong class="text-gradient text-primary mb-0">{{$pencatatan->domain}}</strong>
              <h3 class="mb-4">{{$pencatatan->judul}}</h3>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-10 ms-auto me-auto">
          ...
          <h3 class="title mb-4">{{$pencatatan->judul}}</h3>
              ...
              <div class="container">
                <div class="row align-items-center">
                  ...
                  <div class="col-md-5 ms-lg-auto">
                    <div class="p-3">
                      <img class="w-100 border-radius-md max-height-600 fadeIn2 fadeInBottom" src="{{asset('upload/'.$pencatatan->foto)}}" alt="First slide">
                    </div>
                  </div>
                </div>
              </div>
